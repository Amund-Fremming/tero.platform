...
CREATE INDEX "idx_round_pool_game_type_random_key" ON "round_pool" ("game_type", "random_key");
CREATE UNIQUE INDEX "idx_round_pool_game_type_round_json_unique" ON "round_pool" ("game_type", "round_json");
